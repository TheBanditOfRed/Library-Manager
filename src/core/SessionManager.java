...
/**
 * core.SessionManager is responsible for managing user sessions in the library management system.
...
public class SessionManager {
    ...
    /**
     * Singleton instance of core.SessionManager.
    ...
    /**
     * Returns the singleton instance of core.SessionManager.
     * Uses double-checked locking to ensure thread safety and performance.
     *
     * @return The singleton instance of core.SessionManager
     */
        ...
        if (instance == null) {
            synchronized (lock) {
                if (instance == null) {
                    ...
                    logger.log(Level.INFO, "core.SessionManager initialized");
                }
            }
        }
        return instance;
