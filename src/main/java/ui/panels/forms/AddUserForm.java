...
import static ui.utils.StatusUtils.getStatusMessage;
...
public class AddUserForm {
    ...
    public static JPanel createAddUserFormPanel(GUI gui) {
        ...
        ManagementPanel.userTypeComboBox = new JComboBox<>(new String[]{
                core.ResourceManager.getString("user.type.student"),
                core.ResourceManager.getString("user.type.public"),
        });

        // Field labels
        JLabel userIdLabel = new JLabel(core.ResourceManager.getString("form.user.id") + ":");
        JLabel userNameLabel = new JLabel(core.ResourceManager.getString("form.user.username") + ":");
        JLabel userPasswordLabel = new JLabel(core.ResourceManager.getString("form.user.password") + ":");
        JLabel userTypeLabel = new JLabel(core.ResourceManager.getString("form.user.type") + ":");

        // Button panel
        JPanel buttonPanel = new JPanel();
        JButton saveButton = new JButton(core.ResourceManager.getString("button.adduser"));
        JButton cancelButton = new JButton(core.ResourceManager.getString("form.button.cancel"));
        buttonPanel.add(saveButton);
        buttonPanel.add(cancelButton);

        // Add title panel
        JPanel titlePanel = new JPanel();
        JLabel formTitle = new JLabel(core.ResourceManager.getString("form.header.add.user"));
    ...
    public static JPanel createEditUserFormPanel(GUI gui, String userId, String userName, String userPassword, String userType) {
        ...
        ManagementPanel.userTypeComboBox = new JComboBox<>(new String[]{
                core.ResourceManager.getString("user.type.student"),
                core.ResourceManager.getString("user.type.public"),
                core.ResourceManager.getString("user.type.admin")
        });

        String studentType = ResourceManager.getString("user.type.student");
        String publicType = core.ResourceManager.getString("user.type.public");
        String adminType = core.ResourceManager.getString("user.type.admin");
        ...
        // Button panel
        JPanel buttonPanel = new JPanel();
        JButton saveButton = new JButton(core.ResourceManager.getString("form.button.update"));
        JButton cancelButton = new JButton(core.ResourceManager.getString("form.button.cancel"));
        buttonPanel.add(saveButton);
        buttonPanel.add(cancelButton);
        ...
        // Add title panel
        JPanel titlePanel = new JPanel();
        JLabel formTitle = new JLabel(core.ResourceManager.getString("form.header.edit.user"));
        formTitle.setFont(formTitle.getFont().deriveFont(Font.BOLD, 16));
        titlePanel.add(formTitle);
    ...
    public static void showEditUserDialog(JPanel parentPanel, GUI gui) {
        ...
        gbc.gridx = 0; gbc.gridy = 0;
        dialogPanel.add(new JLabel(core.ResourceManager.getString("form.userid") + ":"), gbc);
        gbc.gridx = 1;
        dialogPanel.add(editUserIdField, gbc);

        gbc.gridx = 0; gbc.gridy = 1;
        dialogPanel.add(new JLabel(core.ResourceManager.getString("form.password") + ":"), gbc);
        gbc.gridx = 1;
        ...
        int result = JOptionPane.showConfirmDialog(
                parentPanel,
                dialogPanel,
                core.ResourceManager.getString("button.edituser"),
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (userId.isEmpty() || password.isEmpty()) {
                DialogUtils.showErrorDialog(parentPanel,
                        core.ResourceManager.getString("validation.fields.required"),
                        core.ResourceManager.getString("validation.error")
                );
                return;
            }
            ...
            try {
                ...
                DataBaseManager dbm = new core.DataBaseManager();
                JsonObject user = dbm.findUser(userId, password);

                if (user == null) {
                    DialogUtils.showErrorDialog(parentPanel,
                            core.ResourceManager.getString("error.user.not.found"),
                ...
                String decryptedPassword = core.SecurityManager.decrypt(user.get("Password").getAsString(), password);
    ...
    private static void handleUserSave(GUI gui, JPanel panel){
        try {
            ...
            core.DataBaseManager dbm = new core.DataBaseManager();

            boolean success = dbm.addUser(userId, userName, userPassword, canonicalUserType);

            if (success) {
                JOptionPane.showMessageDialog(panel,
                        core.ResourceManager.getString("user.add.success"),
                        core.ResourceManager.getString("success"),
                ...
                DialogUtils.showErrorDialog(panel,
                        core.ResourceManager.getString("error.user.add.failed") + "\n" + core.ResourceManager.getString("error.logs.check"),
                        "Database Error"
                );
    ...
    private static void handleEditUserSave(GUI gui, JPanel panel, String originalUserId) {
        try {
            ...
            if (success) {
                JOptionPane.showMessageDialog(panel,
                        core.ResourceManager.getString("user.update.success"),
                        core.ResourceManager.getString("success"),
                        JOptionPane.INFORMATION_MESSAGE);
                ...
                DialogUtils.showErrorDialog(panel,
                        core.ResourceManager.getString("error.user.update.failed"),
                        core.ResourceManager.getString("error")
                );
            }
            ...
            DialogUtils.showErrorDialog(panel,
                    core.ResourceManager.getString("error.user.update") + "\n" + core.ResourceManager.getString("error.logs.check"),
                    core.ResourceManager.getString("error")
            );
        }
    }
    ...
    public static void showRemoveUserDialog(JPanel parentPanel) {
        ...
        int result = JOptionPane.showConfirmDialog(
                parentPanel,
                dialogPanel,
                core.ResourceManager.getString("dialog.removeuser.title"),
                JOptionPane.OK_CANCEL_OPTION,
                JOptionPane.PLAIN_MESSAGE
        );
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (borrowedBooks != null && !borrowedBooks.isEmpty()) {
                DialogUtils.showErrorDialog(parentPanel,
                        core.ResourceManager.getString("error.user.has.books"),
                        core.ResourceManager.getString("error")
                );
                return;
            }
            ...
            int confirm = JOptionPane.showConfirmDialog(parentPanel,
                    core.ResourceManager.getString("confirm.delete.user", userId),
                    core.ResourceManager.getString("confirm"),
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                if (success) {
                    JOptionPane.showMessageDialog(parentPanel,
                            core.ResourceManager.getString("user.remove.success"),
                            core.ResourceManager.getString("success"),
                            JOptionPane.INFORMATION_MESSAGE);
                } else {
                    DialogUtils.showErrorDialog(parentPanel,
                            core.ResourceManager.getString("error.user.remove.failed"),
                            core.ResourceManager.getString("error")
                    );
                }
            }
    ...
    private static JPanel createUserBooksPanel(String userId, String userPassword) {
        ...
        JPanel titlePanel = new JPanel();
        JLabel booksTitle = new JLabel(core.ResourceManager.getString("user.books.title"));
        booksTitle.setFont(booksTitle.getFont().deriveFont(Font.BOLD, 14));
        titlePanel.add(booksTitle);
        
        // Create table for user's books
        String[] columns = {
                core.ResourceManager.getString("column.bookid"),
                core.ResourceManager.getString("column.dateissued"),
                core.ResourceManager.getString("column.status")
        };
        ...
        JButton returnBookButton = new JButton(core.ResourceManager.getString("button.return.book"));
        JButton refreshBooksButton = new JButton(core.ResourceManager.getString("button.refresh"));
    ...
    returnBookButton.addActionListener(_ -> {
        ...
        if (selectedRow == -1) {
            DialogUtils.showErrorDialog(panel,
                    ...
                    core.ResourceManager.getString("warning")
            );
            return;
        }
        ...
        if (bookId.equals(core.ResourceManager.getString("books.none")) ||
            bookId.equals(core.ResourceManager.getString("error.load.books"))) {
            return;
        }
        
        int confirm = JOptionPane.showConfirmDialog(panel,
                core.ResourceManager.getString("confirm.return.admin", bookId),
                core.ResourceManager.getString("confirm"),
                JOptionPane.YES_NO_OPTION);
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                ...
                if (success) {
                    ...
                    DialogUtils.showErrorDialog(panel,
                            core.ResourceManager.getString("error.return.failed"),
                            core.ResourceManager.getString("error")
                    );
                }
                ...
                DialogUtils.showErrorDialog(panel,
                        core.ResourceManager.getString("error.return.exception"),
                        core.ResourceManager.getString("error")
                );
            }
        }
        ...
        try {
            ...
            if (books == null || books.isEmpty()) {
                model.addRow(new Object[]{
                        core.ResourceManager.getString("books.none"),
                        "",
                        ""
                });
                return;
            ...
            DialogUtils.showErrorDialog(panel,
                    core.ResourceManager.getString("error.load.books") + "\n" + core.ResourceManager.getString("error.logs.check"),
                    core.ResourceManager.getString("error")
            );
        }
    }
