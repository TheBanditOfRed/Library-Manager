...
public class PanelSwitcher extends JPanel {
    ...
    public static void switchToMainPanel(GUI gui) {
        logger.log(Level.INFO, "User " + core.SessionManager.getInstance().getCurrentUser() + " successfully authenticated - switching to main panel");

        try {
            try {
                MainApplicationPanel.welcomeLabel.setText(core.ResourceManager.getString("welcome.user", core.SessionManager.getInstance().getCurrentUserName()));
            } catch (Exception e) {
            ...
            try {
                ...
                if (component instanceof JTabbedPane tabbedPane) {
                    ...
                    if ("admin".equals(core.SessionManager.getInstance().getCurrentUser())) {
                        tabbedPane.addTab(core.ResourceManager.getString("tab.manage"), ManagementPanel.createManageBooksPanel(gui));
                    }
                } else {
                ...
                DialogUtils.showErrorDialog(gui,
                        core.ResourceManager.getString("error.ui.component") + ": " + e.getMessage(),
                        core.ResourceManager.getString("error")
                );
            ...
            try {
                ...
                DialogUtils.showErrorDialog(gui,
                        core.ResourceManager.getString("error.ui.navigation") + ": " + e.getMessage(),
                        core.ResourceManager.getString("error")
                );
            }
        } catch (Exception e) {
            ...
            DialogUtils.showErrorDialog(gui,
                    core.ResourceManager.getString("error.login.failed") + ": " + e.getMessage(),
                    core.ResourceManager.getString("error")
            );
            ...
            try {
                ...
                DialogUtils.showErrorDialog(gui,
                        core.ResourceManager.getString("error.critical") + ": " + e.getMessage(),
                        core.ResourceManager.getString("error")
                );
            }
        }
        ...
        try {
            ...
            if (component instanceof JTabbedPane tabbedPane) {
                for (int i = 0; i < tabbedPane.getTabCount(); i++) {
                    if (tabbedPane.getTitleAt(i).equals(core.ResourceManager.getString("tab.manage"))) {
            ...
            DialogUtils.showErrorDialog(MainApplicationPanel.mainPanel,
                    core.ResourceManager.getString("error.switch.panel") + ": " + e.getMessage(),
                    core.ResourceManager.getString("error")
            );
        }
